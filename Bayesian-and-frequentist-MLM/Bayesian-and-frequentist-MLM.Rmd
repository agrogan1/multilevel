...
In contrast, Nalborczyk et al. [-@nalborczyk_batailler_loevenbruck_vilain_bürkner_2019] argue that maximal models are supported under the Bayesian approach. Oberauer [-@Oberauer2022] also argues for including multiple random slopes.
