...
format:
  ...
  pdf:
    ...
    colorlinks: true
  revealjs: 
    output-file: reshaping-data-revealjs.html
    css: revealjs.css
    smaller: true
    scrollable: true
    transition: slide
...
2. `rename` each independent or dependent variable from each time point so that it has the `stub-time` (@tip-stub-time) format.

::: {#tip-stub-time .callout-tip}
### `stub-time` format
