...
The examples below use the `simulated_multilevel_data.dta` file from my text book on *Multilevel Thinking*. Here is a [link](https://agrogan1.github.io/multilevel-workshop/#simulated-multilevel-data) to download the data. 
