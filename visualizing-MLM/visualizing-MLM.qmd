...
citation:
  url: https://agrogan1.github.io/multilevel/visualizing-MLM/visualizing-MLM.html
---
...
The examples below use the `simulated_multilevel_data.dta` file from my text book on [*Multilevel Thinking*](https://agrogan1.github.io/posts/multilevel-thinking/). Here is a [link to download the data](https://agrogan1.github.io/multilevel-workshop/#simulated-multilevel-data). 
