...
Now imagine that community members provide more of the protective factor or more of the intervention in situations where there are lower levels of the desirable outcome. If we think about it, this is a very plausible situation. 
...
p0 + 
  ...
  geom_smooth(aes(color = group), # smoothers with group color
              method = "lm") + 
  labs(title = "beneficial outcome as a function of intervention or treatment",
