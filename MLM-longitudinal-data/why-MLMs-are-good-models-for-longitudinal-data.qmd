...
csl: apa.csl
citation:
  url: https://agrogan1.github.io/multilevel/MLM-longitudinal-data/why-MLMs-are-good-models-for-longitudinal-data.html
---

# Key Idea

::: {.callout-tip}
## Multilevel Models are Useful for Complicated Longitudinal Data and Research Designs

Multilevel models are uniquely suited for complicated longitudinal data and research designs. Among other advantages, multilevel models are able to easily accommodate designs where individuals are observed at different times and different numbers of times.[^longdata]
:::

[^longdata]: Many, if not most, of the advantages listed in this handout will also apply to any approach using long data. 
...
1. Using the algebra in @eq-longitudinal-mlm, these models can easily accommodate both time varying and time invariant variables [@Hox2010; @Hox2018; @Singer2003; @Raudenbush2002; @RabeHesketh2022].
