...
# Advantages of the Multilevel Model for Longitudinal Data [^longdata]
...
[^longdata]: Many, if not most, of the advantages listed below will also apply to any approach using long data. 
