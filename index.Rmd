...
```{r, fig.height=3, fig.cap="Neighborhood, School and Country Effects"}

knitr::include_graphics("neighborhood.png")

```

<aside>
<mark>Stata will be the statistical software employed in this course, and students will need access to Stata to participate.</mark>

<span style="background-color: #00FFFF">For the first time, participation in this class will also require purchase of a textbook, likely *Multilevel and Longitudinal Modeling Using Stata, Fourth Edition, Volume I: Continuous Responses* by Rabe-Hesketh and Skrondal.</span>
</aside>

Multilevel models have become a standard statistical tool for quantitative research on neighborhoods, communities and schools.  The cross-sectional multilevel model is appropriate for situations in which respondents are clustered inside larger social or geographic units e.g. people in geographic areas, residents in neighborhoods, or children in classrooms and/or schools. Cross-sectional multilevel models enable *multilevel thinking* thinking at multiple levels (units of analysis) and conceptualizing effects at the *country*, *community*, *family*, and *individual* levels.
...
<aside>
<mark>Previously this course was numbered SW 832. The new number for the course is SW 864.</mark>
</aside>
...
```{r, fig.height=3, fig.cap="Studies of Growth and Change"}
...
4. Possible additional topics based on student interest (models for dichotomous outcomes; power analysis for single level and multilevel models; meta-analysis)
