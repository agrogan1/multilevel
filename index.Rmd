...
```{r, fig.cap="Neighborhood, School and Country Effects"}
...
<mark>For the first time, participation in this class will also require purchase of a textbook, likely *Multilevel and Longitudinal Modeling Using Stata, Fourth Edition, Volume I: Continuous Responses* by Rabe-Hesketh and Skrondal.</mark>
</aside>
...
```{r, layout="l-page", fig.height= 3.0, fig.cap="A Subsample of The High School and Beyond Data Set", eval=FALSE}
...
```{r, layout="l-page", fig.cap="School Specific Regression Lines", eval=FALSE}
...
```{r, fig.cap="Studies of Growth and Change"}
