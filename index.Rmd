...
> <mark>Currently this course is numbered SW 832, although we are working to get the course number, and formal course title, changed.</mark>

> <mark>Formal course title:  Research Methods for Social Policy Analysis/ Research Methods for Evaluating Social Programs and Human Service Organizations  (Focus on Multilevel and Longitudinal Statistical Modeling)</mark>
...
hsb_small$schoolid <- factor(hsb_small$id, labels = c("A", "B", "C", "D", "E", "F"))

```

```{r, layout="l-screen", fig.height= 3.0, fig.cap="A Subsample of The High School and Beyond Data Set"}
...
# geom_dotplot(dotsize = .25, stackdir = "center")

ggplotly(p0)

ggsave("p0.png", width = 6, height = 2.0)
...
> <mark>This course requires a solid understanding of ordinary least squares regression (OLS) as a starting point.</mark>
...
```{r, layout="l-screen", fig.cap="School Specific Regression Lines"}
