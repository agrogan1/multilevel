...
NB:  You don’t have to include everything I’ve listed here. Try for 80-90%.
...
In order to format my results nicely, I copied them into Excel first, formatted them, and then copied them into Word.
...
A hypothetical example of a graph showing the distribution of one of my variables of interest to give some visual interest to this paper.

Note that I’ve tried to pay some attention to meaningful titles and axis labels.
