...
::: column-margin
A hypothetical example. <span style="color:red;">Note that I have pasted in my *raw* results here. You should devote more attention to *formatting* your results as if for a publication.</span> 

<span style="color:red;">**In order to format my results more nicely,**</span> I could copy them into Excel first, format them, and then copy them into Word. There are also some newer ways to make nicely formatted tables in Stata. Ask the Instructor for details.
...
![A histogram of one variable](myhistogram.png){width=50%}
...
![A scatterplot and linear fit](mytwoway.png){width=50%}
...
Smith, & Jones. (2202). Some very important developmental stuff. *The Journal of Very Important Developmental Stuff*, 1(1), 1-2.
