...
::: column-margin
::: {.callout-tip}
If all my variables are continuous, it's appropriate to show means. If some of my variables are categorical, it's more appropriate to show frequency distributions. The new Stata command `dtable` can be quite helpful in building tables of descriptive statistics e.g. `dtable y x i.z`.
:::
:::
...
quietly: dtable y x i.z, export("table1.md", as(markdown) replace)
...
And the daring are welcome to try my ["Michigan" Stata graph scheme](https://agrogan1.github.io/Stata/michigan-graph-scheme/), or [R package for Michigan colors](https://agrogan1.github.io/michigancolors/), *caveat emptor*.
:::
:::
