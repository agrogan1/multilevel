...
::: column-margin
A hypothetical example. <span style="color:red;">You should devote attention to *formatting* your results as if for a publication. NB: You do not have to copy my format exactly. Especially for a multivariate model, I prefer a more complete presentation using $\beta$, SE, t and p value.</span> 
