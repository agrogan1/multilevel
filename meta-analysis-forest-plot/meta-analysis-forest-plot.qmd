...
nullrefline(favorsleft("Favors No ESP") favorsright("Favors ESP")) // reference line at null w labels

graph export forestplot2.png, replace

```

![forest plot with better labels](forestplot2.png)
