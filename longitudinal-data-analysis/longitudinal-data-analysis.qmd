...
| Statistical Method      | Control for Time Invariant Observed | Control for Time Varying Observed | Control for Time InvariantUnobserved | Control for Time Varying Unobserved | Estimate Reciprocal Causality | Control for Earlier or Baseline y |
|-------------------------|-------------------------------------|-----------------------------------|--------------------------------------|-------------------------------------|-------------------------------|-----------------------------------|
| Multilevel Modeling     | yes                                 | yes                               | partially                            | no                                  | no                            | automatic                         |
| Fixed Effects           | yes                                 | yes                               | yes                                  | no                                  | no                            | automatic                         |
| Cross-Lagged Regression | yes                                 | yes                               | no                                   | no                                  | yes                           | must explicitly specify           |
