...
![Neighborhood, School and Country Effects](neighborhood.png){width=50%}
...
::: {.column-margin}
<span style="background-color: #FFFF00">This course requires a solid understanding of ordinary least squares regression (OLS) as a starting point. Generally this means that one has taken the introductory graduate level 2 semester sequence in statistics in a discipline like Psychology or Sociology.</mark>
:::
...
![Studies of Growth and Change](plant.png){width=50%}
