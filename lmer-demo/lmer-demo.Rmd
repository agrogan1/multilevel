...
```{r, fig.cap="Tree Height by Tree Age"}
...
tab_model(fit0, show.p = FALSE) # nicely formatted table
...
tab_model(fit1, show.p = FALSE) # nicely formatted table
...
tab_model(fit2, show.p = FALSE) # nicely formatted table
...
tab_model(fit3, show.p = FALSE) # nicely formatted table
