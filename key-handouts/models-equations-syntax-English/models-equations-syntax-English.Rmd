...
`///` is a line wrapping character to allow Stata commands to span multiple lines.

For binary outcomes, use command `melogit` instead.

`mixed` without a clustering variable will give very similar results to `regress`.
