...
2. *Unbalanced data is less of a problem*, the data structure and estimation are robust to these possibilities [@Singer2003].
...
6.  Every individual could have a *completely different set of time points* [@Hox2010; @Hox2018; @Singer2003; @Luke2004] and even a *completely different number of time points*.
